...
namespace Entities.Migrations
{
    ...
    [Migration("20220227165631_fix report table")]
            ...
            modelBuilder.Entity("Entities.DataModel.ReportStatus", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2022, 2, 27, 16, 56, 31, 315, DateTimeKind.Utc).AddTicks(3306))
                        .HasColumnName("DateCreated");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = (byte)1,
                            DateCreated = new DateTime(2022, 2, 27, 16, 56, 31, 315, DateTimeKind.Utc).AddTicks(4205),
                            Name = "Hazırlanıyor"
                        },
                        new
                        {
                            Id = (byte)2,
                            DateCreated = new DateTime(2022, 2, 27, 16, 56, 31, 315, DateTimeKind.Utc).AddTicks(4214),
                            Name = "Tamamlandı"
                        });
                });
