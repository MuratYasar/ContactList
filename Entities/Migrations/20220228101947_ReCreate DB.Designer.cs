...
namespace Entities.Migrations
{
    ...
    [Migration("20220228101947_ReCreate DB")]
            ...
            modelBuilder.Entity("Entities.DataModel.ReportStatus", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2022, 2, 28, 10, 19, 47, 660, DateTimeKind.Utc).AddTicks(1340))
                        .HasColumnName("DateCreated");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = (byte)1,
                            DateCreated = new DateTime(2022, 2, 28, 10, 19, 47, 660, DateTimeKind.Utc).AddTicks(2151),
                            Name = "Hazırlanıyor"
                        },
                        new
                        {
                            Id = (byte)2,
                            DateCreated = new DateTime(2022, 2, 28, 10, 19, 47, 660, DateTimeKind.Utc).AddTicks(2160),
                            Name = "Tamamlandı"
                        });
                });
