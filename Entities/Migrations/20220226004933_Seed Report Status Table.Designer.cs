...
namespace Entities.Migrations
{
    ...
    [Migration("20220226004933_Seed Report Status Table")]
    partial class SeedReportStatusTable
    {
            ...
            modelBuilder.Entity("Entities.DataModel.ReportStatus", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2022, 2, 26, 0, 49, 33, 13, DateTimeKind.Utc).AddTicks(9514))
                        .HasColumnName("DateCreated");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = (byte)1,
                            DateCreated = new DateTime(2022, 2, 26, 0, 49, 33, 14, DateTimeKind.Utc).AddTicks(116),
                            Name = "Hazırlanıyor"
                        },
                        new
                        {
                            Id = (byte)2,
                            DateCreated = new DateTime(2022, 2, 26, 0, 49, 33, 14, DateTimeKind.Utc).AddTicks(123),
                            Name = "Tamamlandı"
                        });
                });
